...
*/
export function mandelbrot_parallel(width, height, scale, iterations, center_x, center_y) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.mandelbrot_parallel(retptr, width, height, scale, iterations, center_x, center_y);
...
* @returns {Uint8ClampedArray}
*/
export function mandelbrot(width, height, scale, iterations, center_x, center_y) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.mandelbrot(retptr, width, height, scale, iterations, center_x, center_y);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v1 = getClampedArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
